(function($){
	var bigColorPicker = new function(){
		...
		this.init = function(){
			...
			mixColorArray.push(new RGB(255,0,0),new RGB(0,255,0),new RGB(0,0,255),new RGB(255,255,0),new RGB(0,255,255),new RGB(255,0,255));
		...
		this.showPicker = function(callback,engine){
			bigColorPicker.targetEl = this;
			$(bigColorPicker.targetEl).data("bigpickerCallback",callback==undefined?"undefined":callback);
			...
			function bigpickerShow(event){
				...
				$("#bigpicker").css({"left":pos.left + "px","top":pos.top + "px"}).show();
